...
public class CorporateGuestServices extends JFrame {
    ...
    public void corporateGuestServices() {
        ...
        mainBodySubPanel21.setBorder(BorderFactory.createTitledBorder("MakeBooking "));

        // Guest Services Sub Panel 2: Create Guest Booking Image
        JButton createBooking = new JButton(
                new ImageIcon(((new ImageIcon("C:\\CTSProject\\DemoToolBox2022\\img\\createBooking.png ")).getImage())
                        .getScaledInstance(140, 140,
        ...
        mainBodySubPanel22.setBorder(BorderFactory.createTitledBorder("View Booking"));
        // Guest Services Sub Panel 2: View Guest Booking Image
        JButton viewBooking = new JButton(
                new ImageIcon(((new ImageIcon("C:\\CTSProject\\DemoToolBox2022\\img\\viewBooking.png ")).getImage())
                        .getScaledInstance(140, 140,
                                java.awt.Image.SCALE_SMOOTH)));
        ...
        // Guest Services Sub Panel 2: View Guest Booking Image
        JButton changeBooking = new JButton(
                new ImageIcon(((new ImageIcon("C:\\CTSProject\\DemoToolBox2022\\img\\changeBooking.png")).getImage())
                        .getScaledInstance(140, 140,
                                java.awt.Image.SCALE_SMOOTH)));
        ...
        JButton cancelBooking = new JButton(
                new ImageIcon(((new ImageIcon("C:\\CTSProject\\DemoToolBox2022\\img\\cancelBooking.png")).getImage())
                        .getScaledInstance(140, 140,
                                java.awt.Image.SCALE_SMOOTH)));
        ...
        mainBodySubPanel25.setBorder(BorderFactory.createTitledBorder("Print Monthly Bill"));
        // Guest Services Sub Panel 2: Print Monthly Bill Image
        JButton printMonthlyBill = new JButton(new ImageIcon(
                ((new ImageIcon("C:\\CTSProject\\DemoToolBox2022\\img\\printMonthlyBill.png ")).getImage())
                        .getScaledInstance(140, 140,
                                java.awt.Image.SCALE_SMOOTH)));
