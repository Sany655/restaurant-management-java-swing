...
public class GuestLogin extends JFrame implements ActionListener {
    JTextField tguestID;
        ...
        if (e.getSource() == submit) {
            ...
            if (!tguestID.getText().isEmpty() && !tPassword.getText().isEmpty()) {
                try {
                    tguestID.setText("");
                    tPassword.setText("");
                    String query = "SELECT guestID, name, password, guesttype FROM GUEST WHERE guestID = ? AND password = ? ";
                    ...
                    if (da.rst.next()) {
                        ...
                        if (s1.equals(s4) && s3.equals(s5) &&
                                s6.equals("Individual")) {
                            // JOptionPane.showMessageDialog(null, "Data Match Successfull ");
                            IndividualGuestServices igs = new IndividualGuestServices();
                            user = s7;
