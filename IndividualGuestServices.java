...
public class IndividualGuestServices extends JFrame {
    ...
    public void individualGuestServices(String user) {
        ...
        JButton createBooking = new JButton(
                new ImageIcon(((new ImageIcon("img\\createBooking.png")).getImage()).getScaledInstance(140, 140,
        ...
        JButton viewBooking = new JButton(
                new ImageIcon(((new ImageIcon("img\\viewBooking.png")).getImage()).getScaledInstance(140, 140,
                        java.awt.Image.SCALE_SMOOTH)));
        ...
        // Guest Services Sub Panel 2: View Guest Booking Image
        JButton updateBooking = new JButton(
                new ImageIcon(((new ImageIcon("img\\changeBooking.png")).getImage()).getScaledInstance(140, 140,
                        java.awt.Image.SCALE_SMOOTH)));
        updateBooking.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        SearchGuestBooking sgb = new SearchGuestBooking();
                        sgb.searchGuestBooking(user);
        ...
        mainBodySubPanel23.add(updateBooking);
        ...
        JButton cancelBooking = new JButton(
                new ImageIcon(((new ImageIcon("img\\cancelBooking.png")).getImage()).getScaledInstance(140, 140,
                        java.awt.Image.SCALE_SMOOTH)));
