...
/**
 * PrintMonthlyBill.java 05/04/22
 *
...
public class PrintMonthlyBill {
    public void PrintMonthlyBill() throws Exception {
        ...
        try {
            ...
            String fileName = "C:\\group1toolbox\\img\\MonthlyBill.txt";
            ...
            pw.println(String.format("%1$5s", "|")
                    + "---------------------------------------------------------------------------------------------------------------------------------------------|");
            pw.println(String.format("%1$5s", "|") + String.format("%1$-5s",
                    " ") + String.format("%1$-10s", "billId") + String.format("%1$-5s", "|") +
                    String.format("%1$-20s", "guestId") + String.format("%1$-5s", "|") +
                    String.format("%1$-20s", "Start Date") + String.format("%1$-5s", "|") +
                    String.format("%1$-25s", "End Date") + String.format("%1$-5s", "|") +
                    String.format("%1$-15s", "Total Amount") + String.format("%1$-5s", "|") +
                    String.format("%1$-10s", "Paid"));// + String.format("%1$12s", "|"));
            pw.println(String.format("%1$5s", "|")
                    + "---------------------------------------------------------------------------------------------------------------------------------------------|");
