...
public class RegisterGuest extends JFrame implements ActionListener {
    ...
    public void registerGuest() {
        ...
        JMenuItem menu31 = new JMenuItem("User Guide");
        JMenuItem menu32 = new JMenuItem("Frequently Asked Questions");
        JMenuItem menu33 = new JMenuItem("About Hotel Online Management System ");
        JMenuItem menu34 = new JMenuItem("About Development Team");
        JMenuItem menu35 = new JMenuItem("Legal Agreement and Copyright");
        JMenuItem menu36 = new JMenuItem("Hotel Brief");
        ...
        JLabel title = new JLabel("GUEST REGISTRATION PORTAL");
        ...
        taddress.setLocation(150, 80);
        taddress.setBackground(Color.WHITE);
        taddress.setLineWrap(true);
        taddress.setEditable(true);
        taddress.addKeyListener(new KeyAdapter() //Prevent Tabbing within the TextArea  
            {
        ...
        taddressScroll.setLocation(150, 80);
        ...
        lphone.setFont(new Font("Arial", Font.PLAIN, 14));
        lphone.setSize(120, 20);
        lphone.setLocation(20, 140);
        mainBodySubPanel2.add(lphone);
        ...
        tphone = new JFormattedTextField(tphoneMask);
        tphone.setFont(new Font("Arial", Font.PLAIN, 15));
        tphone.setSize(210, 20);
        tphone.setLocation(150, 140);
        taddress.setNextFocusableComponent(tphone);
        mainBodySubPanel2.add(tphone);
        ...
        temail.setLocation(150, 170);
        tphone.setNextFocusableComponent(temail);
        mainBodySubPanel2.add(temail);
        //------------------------------------------------------------------
        //Guest Sub Panel 2: The Guest Type label on the form
        JLabel lguestType = new JLabel("Guest Type*");
        lguestType.setFont(new Font("Arial", Font.PLAIN, 14));
        lguestType.setSize(120, 20);
        lguestType.setLocation(20, 200);
        mainBodySubPanel2.add(lguestType);
        ...
        tguestType = new JComboBox(guestRoles);
        tguestType.setSize(210, 20);
        tguestType.setLocation(150, 200);
        temail.setNextFocusableComponent(tguestType);
        mainBodySubPanel2.add(tguestType);
        ...
        lcreditCardNo.setLocation(450, 20);
        ...
        tcreditCardNo.setLocation(600, 20);
        tguestType.setNextFocusableComponent(tcreditCardNo);
        mainBodySubPanel2.add(tcreditCardNo);

        //------------------------------------------------------------------
        //Guest Sub Panel 2: The Guest Credit Card Expiry Date label on the form 
        JLabel lcreditCardExpiryDate = new JLabel("CC Expiry Date*");
        lcreditCardExpiryDate.setFont(new Font("Arial", Font.PLAIN, 14));
        lcreditCardExpiryDate.setSize(120, 20);
        lcreditCardExpiryDate.setLocation(450, 50);
        mainBodySubPanel2.add(lcreditCardExpiryDate);
        ...
        tcreditCardExpiryDate = new JFormattedTextField(creditCardExpiryDateMask);
        tcreditCardExpiryDate.setFont(new Font("Arial", Font.PLAIN, 15));
        tcreditCardExpiryDate.setSize(100, 20);
        tcreditCardExpiryDate.setLocation(600, 50);
        tcreditCardNo.setNextFocusableComponent(tcreditCardExpiryDate);
        mainBodySubPanel2.add(tcreditCardExpiryDate);
        lcreditCardExpiryDate = new JLabel("(yyyy-mm-dd)");
        lcreditCardExpiryDate.setFont(new Font("Arial", Font.PLAIN, 14));
        lcreditCardExpiryDate.setSize(120, 20);
        lcreditCardExpiryDate.setLocation(710, 50);
        mainBodySubPanel2.add(lcreditCardExpiryDate);
        //------------------------------------------------------------------
        //Guest Sub Panel 2: The Guest Credit Card Code label on the form
        JLabel lcreditCardCode = new JLabel("CVV Code*");
        lcreditCardCode.setFont(new Font("Arial", Font.PLAIN, 14));
        lcreditCardCode.setSize(120, 20);
        lcreditCardCode.setLocation(450, 80);
        mainBodySubPanel2.add(lcreditCardCode);
        ...
        tcreditCardCode = new JFormattedTextField(creditCardCodeMask);
        tcreditCardCode.setFont(new Font("Arial", Font.PLAIN, 15));
        tcreditCardCode.setSize(45, 20);
        tcreditCardCode.setLocation(600, 80);
        tcreditCardExpiryDate.setNextFocusableComponent(tcreditCardCode);
        mainBodySubPanel2.add(tcreditCardCode);
        //------------------------------------------------------------------
        ...
        ldiscount.setLocation(450, 110);
        mainBodySubPanel2.add(ldiscount);
        //Guest Sub Panel 2: The Guest Discount textbox on the form
        tdiscount = new JFormattedTextField(new DecimalFormat("###.##"));
        tdiscount.setFont(new Font("Arial", Font.PLAIN, 15));
        tdiscount.setSize(45, 20);
        tdiscount.setLocation(600, 110);
        tdiscount.setText(lastDouble + "");
        tdiscount.selectAll();
        tcreditCardCode.setNextFocusableComponent(tdiscount);
        mainBodySubPanel2.add(tdiscount);

        //------------------------------------------------------------------
        //Guest Sub Panel 2: The Guest Registration Date label on the form
        JLabel lregistrationDate = new JLabel("Registration Date*");
        lregistrationDate.setFont(new Font("Arial", Font.PLAIN, 14));
        lregistrationDate.setSize(120, 20);
        lregistrationDate.setLocation(450, 140);
        mainBodySubPanel2.add(lregistrationDate);
        ...
        tregistrationDate = new JFormattedTextField(registrationDateMask);
        tregistrationDate.setFont(new Font("Arial", Font.PLAIN, 15));
        tregistrationDate.setSize(100, 20);
        tregistrationDate.setLocation(600, 140);
        tdiscount.setNextFocusableComponent(tregistrationDate);
        mainBodySubPanel2.add(tregistrationDate);
        lregistrationDate = new JLabel("(yyyy-mm-dd)");
        lregistrationDate.setFont(new Font("Arial", Font.PLAIN, 14));
        lregistrationDate.setSize(120, 20);
        lregistrationDate.setLocation(710, 140);
        mainBodySubPanel2.add(lregistrationDate);
        ...
        tpassword.setLocation(600, 170);
        tregistrationDate.setNextFocusableComponent(tpassword);
        ...
        lconfirmPassword.setFont(new Font("Arial", Font.PLAIN, 14));
        lconfirmPassword.setSize(120, 20);
        lconfirmPassword.setLocation(450, 200);
        mainBodySubPanel2.add(lconfirmPassword);
        ...
        tconfirmPassword.setSize(210, 20);
        tconfirmPassword.setLocation(600, 200);
        tpassword.setNextFocusableComponent(tconfirmPassword);
        mainBodySubPanel2.add(tconfirmPassword);


        //------------------------------------------------------------------
        //Guest Sub Panel 3: Guest Details Sub Panel3: The Tabbed Panel
        JPanel mainBodySubPanel3 = new JPanel();
        mainBodySubPanel3.setLayout(new GridLayout(1, 1));
        mainBodySubPanel3.setPreferredSize(new Dimension(850, 210));
        mainBodySubPanel3.setBorder(BorderFactory.createTitledBorder("Guest Details "));

        JTabbedPane tabbedPane = new JTabbedPane(JTabbedPane.TOP);
        //Guest Sub Panel 3: Additional Guest Details Sub Panel3: Tab 1, Additional Guest Details TextArea 
        JPanel tadditionalGuestDetailsPanel = new JPanel();
        tadditionalGuestDetails = new JTextArea(8, 62);
        tadditionalGuestDetails.setFont(new Font("Arial", Font.PLAIN, 15));
        tadditionalGuestDetails.setSize(105, 245);

        tadditionalGuestDetails.setBorder(BorderFactory.createLineBorder(Color.green));
        tadditionalGuestDetails.setLocation(1, 0);
        tadditionalGuestDetails.setBackground(Color.WHITE);
        tadditionalGuestDetails.setLineWrap(true);
        tadditionalGuestDetails.setEditable(true);

        JScrollPane additionalGuestDetailsScroll = new JScrollPane(tadditionalGuestDetails);
        additionalGuestDetailsScroll.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        tadditionalGuestDetailsPanel.add(additionalGuestDetailsScroll);
        ...
        JPanel tgeneralNotesPanel = new JPanel();
        tgeneralNotes = new JTextArea(8, 62);
        tgeneralNotes.setFont(new Font("Arial", Font.PLAIN, 15));
        tgeneralNotes.setSize(105, 245);
        tgeneralNotes.setLocation(1, 0);
        tgeneralNotes.setBackground(Color.WHITE);
        tgeneralNotes.setLineWrap(true);
        tgeneralNotes.setEditable(true);

        JScrollPane generalNotesScroll = new JScrollPane(tgeneralNotes);
        generalNotesScroll.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        tgeneralNotesPanel.add(generalNotesScroll);
        tabbedPane.addTab("General Notes", tgeneralNotesPanel);
        tconfirmPassword.setNextFocusableComponent(tabbedPane);
        mainBodySubPanel3.add(tabbedPane);
        //------------------------------------------------------------------
        ...
        tabbedPane.setNextFocusableComponent(submit);
