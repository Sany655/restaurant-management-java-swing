...
public class StaffViewBooking extends JFrame implements ActionListener {
    ...
    // ----------------------------------------------------------------------
    public void staffViewBooking(String[] info) {
        ...
        //-------------------------------------------------------------------
        //View Booking Sub Panel 2: The Booking Date label on the
        form
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submit) {
            ...
            try {
                StaffUpdateBooking sub = new StaffUpdateBooking();
                sub.staffUpdateBooking(passedInfo);
                setVisible(true);
                this.dispose();
            } catch (Exception ex) {
                System.out.println(ex);
