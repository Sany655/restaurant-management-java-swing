...
/**
 * StringAlignUtils.java
 * The String Alignment Utility class
 *
 * @Author CTS Unique Touch Pro
 * @Version v1.0 05th April 2022
 * @Date April 05, 2022
 *
 * This is a String Alignment Utility class that provides text alignment.
 */
...
public class StringAlignUtils extends Format {
     ...
     * {
     * String sampleText = "Lorem ipsum dolor sit amet, consectetur
     ...
     * 
     * util = new StringAlignUtils(50, Alignment.RIGHT);
     * System.out.println( util.format(sampleText) );
     * 
     * util = new StringAlignUtils(50, Alignment.CENTER);
     * System.out.println( util.format(sampleText) );
     * 
     * }
     */
