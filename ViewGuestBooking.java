...
public class ViewGuestBooking extends JFrame implements ActionListener {
    ...
    String bookingId, dateBooked, checkInDate, checkOutDate, roomType, roomNo, bookingStatus, guestId, billToGuestId,
            hotelStaffId;
    ...
    // ----------------------------------------------------------------------
 public void viewGuestBooking(String[] info)
 {
...
Vector object
 ...
 (Item)billToGuestIdComboBox.getSelectedItem();
  ...
  //Query to retrieve the HotelStaff data from the database and
 ...
 setVisible(true);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submit) {
            ...
            try {
                UpdateGuestBooking ugb = new UpdateGuestBooking();
                ugb.updateGuestBooking(passedInfo);
                setVisible(true);
                this.dispose();
            } catch (Exception ex) {
                System.out.println(ex);
