...
public class group1toolbox extends JFrame {
    ...
    public void mainHome() {
        ...
        // Adding Components to the File navigation option on the Main MenuBar
        ...
        ImagePanel mainBodySubPanel1 = new ImagePanel(new ImageIcon("img/mainDemo.jpg").getImage());
        mainBodySubPanel1.setPreferredSize(new Dimension(1068, 427));
